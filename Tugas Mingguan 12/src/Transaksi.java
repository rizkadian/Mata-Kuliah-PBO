...
public class Transaksi {
    ...
    public void cetak_data(){
        java.io.File file = new java.io.File("Struck Pembayaran.txt");
        try {
            System.out.println();
            System.out.println("=====================================================");
            ...
            output.println("=====================================================");
            output.println("                   STRUCK PENYEWAAN ");
            output.println("=====================================================");
            output.println(" Jaminan         : " + jaminan);
            output.println(" Tanggal Sewa    : " + tanggal_sewa);
            output.println(" Tanggal Kembali : " + jumlah(tanggal_sewa, jumlah_hari));
            output.println("-----------------------------------------------------");
            output.println(" Nama Alat Musik - " + Alat.getId_alatmusik() + " " + Alat.getNama_alatmusik());
            output.println(" Jumlah                                   : " + jumlah_item);
            output.println(" Harga                                    : " + Alat.getHarga());
            output.println("-----------------------------------------------------");
            output.println(" Total                                    : " + jumlah(jumlah_hari, Alat.getHarga(), jumlah_item));
            output.println(" Bayar                                    : " + bayar);
            output.println(" Kembali                                  : " + jumlah(bayar));
            output.println("=====================================================");
            output.close();
        }
